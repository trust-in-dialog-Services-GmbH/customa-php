 ...
 */
class CampaignV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignV4';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the campaign. Set internally by Customa, any given value is ignored.
     *
     * @return self
     */
     ...
     * Sets referrer
     *
     * @param string $referrer Referrer of the campaign.
     *
     * @return self
     */
     ...
     * Sets groups
     *
     * @param string[]|null $groups IDs of the campaign groups this campaign belongs to.
     *
     * @return self
     */
