...
class ProductV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'set_parts' => '\Tid\CustomaPHP\Model\ProductSetPartV4[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('set_parts', $data ?? [], null);
    ...
    */
     ...
     * Sets category
     *
     * @param string|null $category Category of the product. Deprecated. Use 'Categories' instead.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets categories
     *
     * @param string[]|null $categories Categories of the product.
     *
     * @return self
     */
     ...
     * Gets set_parts
     *
     * @return \Tid\CustomaPHP\Model\ProductSetPartV4[]|null
     */
    public function getSetParts()
    {
        return $this->container['set_parts'];
    }

    /**
     * Sets set_parts
     *
     * @param \Tid\CustomaPHP\Model\ProductSetPartV4[]|null $set_parts Parts of the product, if this product is a product set.
     *
     * @return self
     */
    public function setSetParts($set_parts)
    {
        if (is_null($set_parts)) {
            array_push($this->openAPINullablesSetToNull, 'set_parts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('set_parts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['set_parts'] = $set_parts;
