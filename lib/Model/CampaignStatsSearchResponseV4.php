...
/**
 * CampaignStatsSearchResponseV4 Class Doc Comment
 *
 * @category Class
 * @package  Tid\CustomaPHP
 * @author   OpenAPI Generator team
 ...
 */
class CampaignStatsSearchResponseV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignStatsSearchResponseV4';
    ...
    protected static $openAPITypes = [
        'campaign_stats' => '\Tid\CustomaPHP\Model\CampaignStatsV4[]',
        'total_count' => 'int',
        'current_page' => 'int',
        'pages_count' => 'int',
        'page_size' => 'int'
    ...
    {
        $this->setIfExists('campaign_stats', $data ?? [], null);
    ...
    */
     ...
     * Gets campaign_stats
     *
     * @return \Tid\CustomaPHP\Model\CampaignStatsV4[]|null
     */
     ...
     * Sets campaign_stats
     *
     * @param \Tid\CustomaPHP\Model\CampaignStatsV4[]|null $campaign_stats campaign_stats
     *
     * @return self
     */
    public function setCampaignStats($campaign_stats)
    {
        if (is_null($campaign_stats)) {
            throw new \InvalidArgumentException('non-nullable campaign_stats cannot be null');
        }
