...
/**
 * CampaignGroupSearchResponseV4 Class Doc Comment
 *
 * @category Class
 * @package  Tid\CustomaPHP
 * @author   OpenAPI Generator team
 ...
 */
class CampaignGroupSearchResponseV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignGroupSearchResponseV4';
    ...
    protected static $openAPITypes = [
        'campaign_groups' => '\Tid\CustomaPHP\Model\CampaignGroupV4[]',
        'total_count' => 'int',
        'current_page' => 'int',
        'pages_count' => 'int',
        'page_size' => 'int'
    ...
    protected static $setters = [
        'campaign_groups' => 'setCampaignGroups',
    ...
    protected static $getters = [
        'campaign_groups' => 'getCampaignGroups',
    ...
    {
        $this->setIfExists('campaign_groups', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets campaign_groups
     *
     * @return \Tid\CustomaPHP\Model\CampaignGroupV4[]|null
     */
    public function getCampaignGroups()
    {
        return $this->container['campaign_groups'];
    }

    /**
     * Sets campaign_groups
     *
     * @param \Tid\CustomaPHP\Model\CampaignGroupV4[]|null $campaign_groups campaign_groups
     *
     * @return self
     */
    public function setCampaignGroups($campaign_groups)
    {
        if (is_null($campaign_groups)) {
            throw new \InvalidArgumentException('non-nullable campaign_groups cannot be null');
        }
        $this->container['campaign_groups'] = $campaign_groups;
