...
/**
 * StrictProduct Class Doc Comment
 *
 * @category Class
 * @package  Tid\CustomaPHP
 * @author   OpenAPI Generator team
 ...
 */
class StrictProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StrictProduct';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['ean']) > 32)) {
        ...
        if ((mb_strlen($this->container['manufacturer']) > 64)) {
        ...
        if ((mb_strlen($this->container['vendor']) > 128)) {
     ...
     * Sets parent
     *
     * @param string $parent ID of the parent product. The parent must be standalone and not have a parent itself.
     *
     * @return self
     */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $number when calling StrictProduct., must be smaller than or equal to 255.');
        }
    ...
    public function setEan($ean)
    {
        ...
        if ((mb_strlen($ean) > 32)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling StrictProduct., must be smaller than or equal to 32.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StrictProduct., must be smaller than or equal to 255.');
        }
    ...
    public function setManufacturer($manufacturer)
    {
        ...
        if ((mb_strlen($manufacturer) > 64)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer when calling StrictProduct., must be smaller than or equal to 64.');
        }
    ...
    public function setVendor($vendor)
    {
        ...
        if ((mb_strlen($vendor) > 128)) {
            throw new \InvalidArgumentException('invalid length for $vendor when calling StrictProduct., must be smaller than or equal to 128.');
        }
     ...
     * Sets status
     *
     * @param bool $status Whether the product is active or inactive.
     *
     * @return self
     */
     ...
     * Sets tax_class
     *
     * @param string $tax_class Tax class of the product. For example, in Germany, 19% VAT would be 'Normal' while 7% VAT would be 'Reduced'.
     *
     * @return self
     */
     ...
     *
     * @param \Tid\CustomaPHP\Model\AdditionalField[] $additional_fields Additional field data for the product.
     *
     * @return self
     */
