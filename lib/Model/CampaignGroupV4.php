...
/**
 * CampaignGroupV4 Class Doc Comment
 *
 * @category Class
 * @package  Tid\CustomaPHP
 * @author   OpenAPI Generator team
 ...
 */
class CampaignGroupV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignGroupV4';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the campaign group. Set internally by Customa, any given value is ignored.
     *
     * @return self
     */
     ...
     * Sets referrer
     *
     * @param string $referrer Referrer of the campaign group.
     *
     * @return self
     */
     ...
     * Sets parent
     *
     * @param string|null $parent ID of the parent campaign group, or null if this campaign group has no parent.
     *
     * @return self
     */
     ...
     * Sets campaigns
     *
     * @param string[]|null $campaigns IDs of the campaigns belonging to this campaign group.
     *
     * @return self
     */
