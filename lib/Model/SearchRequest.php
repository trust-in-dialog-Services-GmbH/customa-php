...
class SearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ENTITY_TYPE_RECEIPT = 'Receipt';
    ...
    */
     ...
     * Sets entity_type
     *
     * @param string|null $entity_type Type of the entity to be searched. Only required in the generic search endpoint.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets filter
     *
     * @param \Tid\CustomaPHP\Model\SearchFilter[] $filter Filters to be applied to the search. The filters are combined using boolean AND. If a filter contains multiple values, these are combined using boolean OR.
     *
     * @return self
     */
