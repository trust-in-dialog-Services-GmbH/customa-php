...
/**
 * StatsReceiptItemType Class Doc Comment
 *
 * @category Class
 ...
 */
class StatsReceiptItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatsReceiptItemType';
    ...
    */
     ...
     * Sets amount
     *
     * @param int $amount The total amount of items of the receipts of the specified type. This is the sum of the amount of items of all receipts of the specified type.
     *
     * @return self
     */
