...
/**
 * StrictReceiptItem Class Doc Comment
 *
 * @category Class
 * @package  Tid\CustomaPHP
 * @author   OpenAPI Generator team
 ...
 */
class StrictReceiptItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StrictReceiptItem';
    ...
    */
     ...
     * Sets tax_class
     *
     * @param string $tax_class Tax class of the item. For example, in Germany, 19% VAT would be 'Normal' while 7% VAT would be 'Reduced'.
     *
     * @return self
     */
