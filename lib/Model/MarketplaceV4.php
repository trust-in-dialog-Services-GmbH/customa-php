...
/**
 * MarketplaceV4 Class Doc Comment
 *
 * @category Class
 * @package  Tid\CustomaPHP
 * @author   OpenAPI Generator team
 ...
 */
class MarketplaceV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketplaceV4';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the marketplace. Set internally by Customa, any given value is ignored.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Display name of the marketplace.
     *
     * @return self
     */
