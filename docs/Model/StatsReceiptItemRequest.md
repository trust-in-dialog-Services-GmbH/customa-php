...
**group_by** | **string** | Grouping criteria for the statistics. This may depend on dynamically configured fields. Use the stats_receipt_item_groupings endpoint to retrieve a list of available groupings. |
